						...
						<div class="row">
							...
							<!-- Photos -->
								<section class="4u 12u(mobile)">
									...
									<div class="row 25%">
										<div class="6u">
											<a href="#" class="image fit"><img src="<?php echo $this->Url->build('/');?>images/pic10.jpg" alt="" /></a>
										</div>
										<div class="6u$">
											<a href="#" class="image fit"><img src="<?php echo $this->Url->build('/');?>images/pic11.jpg" alt="" /></a>
										</div>
										<div class="6u">
											<a href="#" class="image fit"><img src="<?php echo $this->Url->build('/');?>images/pic12.jpg" alt="" /></a>
										</div>
										<div class="6u$">
											<a href="#" class="image fit"><img src="<?php echo $this->Url->build('/');?>images/pic13.jpg" alt="" /></a>
										</div>
										<div class="6u">
											<a href="#" class="image fit"><img src="<?php echo $this->Url->build('/');?>images/pic14.jpg" alt="" /></a>
										</div>
										<div class="6u$">
											<a href="#" class="image fit"><img src="<?php echo $this->Url->build('/');?>images/pic15.jpg" alt="" /></a>
										</div>
									</div>
								</section>
