<article id="main" class="special">
	<div class="portfolio1" id="gallery">
		<div class="container">
			<header>
				<h2 style="font-size: 2.85em" class="text-center"><a href="<?php echo $this->Url->build('/');?>Desserts">Desserts</a></h2>
			</header>
			<div class="agileits_portfolio_grids">
				...
				<div class="col-sm-3 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="<?php echo $this->Url->build('/');?>Desserts/details/<?php echo $dessert['metaname'];?>">
							<img src="<?php echo $this->Url->build('/');?>images/<?php echo $dessert['image'];?>" alt=" " class="img-responsive">
							<div class="overlay">
