                ...
                <?php foreach($similiar_recipe as $similar):?>
           		<div class="col-sm-3 col-xs-6">
                    <div class="product animated fadeInUp" style="visibility: visible;">
           				<a href="<?php echo $this->Url->build('/');?>breakfast/<?php echo $similar['metaname'];?>">
           			    ...
           			    <div class="overlay">
               				<div class="detail">
               					<h4><a href="<?php echo $this->Url->build('/');?>breakfast/<?php echo $similar['metaname'];?>"><?php echo $similar['name'];?></a></h4>
               				</div>
           			    </div>
           			</div>
                </div>
