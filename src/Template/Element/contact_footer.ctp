...
<section class="contact">
	<header>
		<h3>Are you happy with our site?</h3>
	</header>
	<p>We share our blogs in our pages also. Check our pages for recent updates of Aapna Recipe.</p>
	<ul class="icons">
...
<div class="copyright">
	<ul class="menu">
		<li>&copy; Aapna Recipe. All rights reserved.</li>
	</ul>
</div>