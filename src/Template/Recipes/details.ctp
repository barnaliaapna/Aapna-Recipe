...
<div class="row">
	...
	<article class="4u 12u(mobile) special">
		<a href="<?php echo $this->Url->build('/');?>recipe/<?php echo $similar['metaname'];?>" class="image featured"><img src="<?php echo $this->Url->build('/');?>images/<?php echo $similar['image'];?>" alt="" width="400px" height="300px" /></a>
		<header>
