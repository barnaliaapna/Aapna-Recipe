<div class="content fullpage homepage">
	<div class="breadcrumb">American Recipes</div>	
	...
	<div class="col-md-6 col-sm-4 height-full">
	    <div class="height-full">
	        ...
	        <div class="col-md-6 col-xs-12 height-half animated fadeInDown">
	        	<div class="block height-full" style="background: url(<?php echo $this->Url->build('/');?>images/american.gif);background-repeat: no-repeat;   background-size: cover;">
	        	</div>
	        </div>
